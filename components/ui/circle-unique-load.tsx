...
export function Loading({ screenHFull = true }: loadingProps) {
  ...
  return (
    <div className={`${screenHFull ? "min-h-screen" : ""} relative flex flex-col items-center justify-center bg-background transition-colors duration-300`}>
      ...
      <p className="text-sm font-bold uppercase tracking-widest text-center mt-2 text-foreground transition-colors duration-300">
        {loadText}
